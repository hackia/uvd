set -l commands install uninstall reinstall search update upgrade verify info publish login logout list init export archive remote add rm submit
complete -c uvd -f
...
complete -c uvd -n "not __fish_seen_subcommand_from $commands" -a "create-usb" -d "create a usb verified drive from disc" -f
complete -c uvd -n "not __fish_seen_subcommand_from $commands" -a "create-uvd" -d "pack the source code in archive" -r
complete -c uvd -n "not __fish_seen_subcommand_from $commands" -a "remote" -d "manage remote url" -r
complete -c uvd -n "not __fish_seen_subcommand_from $commands" -a "new" -d "create a new uvd project"
...
complete -c uvd -n "not __fish_seen_subcommand_from $commands" -a "submit" -d "send the archive to make an atomic new version for all systems" -r